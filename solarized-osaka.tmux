...
#+--- Windows ---+
# Focus
tmux set -g window-status-current-format "${RESET}#[bg=${THEME[bgreen]}] #[fg=${THEME[red]},bold,nodim]$window_number #W#[nobold]#{?window_zoomed_flag, $zoom_number, $custom_pane}"
# Unfocused
